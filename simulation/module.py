...
class Module:
    ...
    def __init__(self, State, County, Interventions):
        ...
        @param County: County of Data
        @param Interventions: Unknown?
        """
        self.__State = State
    ...
    def createPopulationObj(self):
        """
        Loads a poulation object with specific state and county data.
        @return: Population object loaded with state and county data.
        """
    ...
    def createPopulation(self, city):
        """
        Loads population object with city data
        @param city: Either 'Anytown' or 'Oklahoma City' so far
    ...
    def createSubmodules(self):
        """
        Reads all of the submodules defined in submodules.json, and saves each of them into a list
        @return: subList, a list of submodules
        """
    ...
    def movePop(self, TOD, DOW, population, facilities):
        """
        CHANGE: Not sure what this does right now
        @param TOD: Unknown
        @param DOW: Unknown
        @param population: Population object generated by createpopulation
        @param facilities: Dictionary containing the names of facilities and the corresponding
        facility object.
        @return: Nothing, it just changes population and facilities.
        """
    ...
    def createFacilities(self, filename):
        """
        Function to create facilities, a dictionary that will have the names of facilities and corresponding
        information about the facility.
        @param filename: json file where information about facilities is stored
        @return: facilities dictionary,
        totalCapacities: an integer representing the total capacity of all facilities
        openHours: a dictionary, not sure about structure.
        """
    ...
    def createFacilitiesTXT(self, filename, verbose):
        """
        Same as createFacilities, but instead of taking the information from a json file it takes it from
        a txt file.
        @param filename: file to take facilities information from, currently not being used (hardcoded
        facilities_info.txt
        @param verbose: Optional command to print the total facilities
        @return: facilities dictionary,
        totalCapacities: an integer representing the total capacity of all facilities
        openHours: a dictionary, not sure about structure.
        """
    ...
    def createFacilitiesCSV(self, filename):
        ...
        @param filename: CSV file to take facilities information from
        @return: facilities dictionary,
        totalCapacities: an integer representing the total capacity of all facilities
        openHours: a dictionary, not sure about structure.
        """
